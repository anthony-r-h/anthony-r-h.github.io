...
!function(c){c.fn.simpleJekyllSearch=function(e){var n=c.extend({jsonFile:"/search.json",jsonFormat:"title,tags,categories,url,date,description",template:'<li><article><a href="{url}">{title}<span class="entry-date"><time datetime="{date}">{date}</time></span></a></article></li>',searchResults:".search-results",limit:"10",noResults:'<p class="search-no-results">No results found.</p>'},e),o=n.jsonFormat.split(","),a=[],l=this,i=c(n.searchResults);function r(){i.children().remove()}n.jsonFile.length&&i.length&&c.ajax({type:"GET",url:n.jsonFile,dataType:"json",success:function(e,t,s){a=e,l.keyup(function(e){var t,s,l;c(this).val().length?(s=c(this).val(),l=[],c.each(a,function(e,t){for(e=0;e<o.length;e++)void 0!==t[o[e]]&&-1!==String(t[o[e]]).toLowerCase().indexOf(s.toLowerCase())&&(l.push(t),e=o.length)}),t=l,r(),i.append(c(n.searchResultsTitle)),t.length?c.each(t,function(e,t){if(e<n.limit){for(var s=n.template,e=0;e<o.length;e++)var l=new RegExp("{"+o[e]+"}","g"),s=s.replace(l,void 0!==t[o[e]]?t[o[e]]:"");i.append(c(s))}}):i.append(n.noResults)):r()})},error:function(e,t,s){console.log("***ERROR in simpleJekyllSearch.js***"),console.log(e),console.log(t),console.log(s)}})}}(Zepto);
...
!function(o,e){o("#menu").click(function(){o("body").addClass("push-menu-to-right"),o("#sidebar").addClass("open"),o(".overlay").addClass("show")}),o("#mask").click(function(){o("body").removeClass("push-menu-to-right"),o("#sidebar").removeClass("open"),o(".overlay").removeClass("show")}),o(e).scroll(function(){0<o(this).scrollTop()?o("body").addClass("light"):o("body").removeClass("light")});var s={close:o(".icon-remove-sign"),searchform:o(".search-form"),canvas:o("body"),dothis:o(".dosearch")};function a(){o(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.canvas.removeClass("search-overlay")}s.dothis.on("click",function(){o(".search-wrapper").toggleClass("active"),s.searchform.toggleClass("active"),s.searchform.find("input").focus(),s.canvas.toggleClass("search-overlay"),o(".search-field").simpleJekyllSearch()}),s.close.on("click",a),document.addEventListener("keyup",function(e){27==e.keyCode&&o(".search-overlay").length&&a()}),1<=document.getElementsByClassName("home").length&&new AnimOnScroll(document.getElementById("grid"),{minDuration:.4,maxDuration:.7,viewportFactor:.2}),smoothScroll.init({selectorHeader:".bar-header",speed:500,updateURL:!1})}(Zepto,window);
